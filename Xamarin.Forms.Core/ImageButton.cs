		...
		IBackgroundView
	{
		...
		public static readonly BindableProperty CommandProperty 
			= BindableProperty.Create(
					...
					typeof(ImageButton), 
					null, 
					propertyChanging: (bo, o, n) => ((ImageButton)bo).CommandChanging?.Invoke(bo, new BindableValueChangedEventArgs(bo, o, n)),
					propertyChanged: (bo, o, n) => ((ImageButton)bo).CommandChanged?.Invoke(bo, new BindableValueChangedEventArgs(bo, o, n))
				);
		...
		public event EventHandler<BindableValueChangedEventArgs> CommandChanged;
		public event EventHandler<BindableValueChangedEventArgs> CommandChanging;
